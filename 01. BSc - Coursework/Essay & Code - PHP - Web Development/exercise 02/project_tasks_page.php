<?php
	...
	$tasks = get_project_tasks($_POST['project_id']);
	
	if (!$tasks)
	{
		// Δεν υπάρχουν μη ανεγνωσμένα μηνυματα για τον υπεύθυνο.
		$_SESSION['message'] = 'There are no project tasks assigned!';
		$_SESSION['reference'] = 'all_projects_page.php';
	...
	print '<html>
	<body>
		<h1 align="center">Project\'s tasks</h1>
		<hr>
		<br>
			<table border="1">
	...
	while ( $row = mysql_fetch_row($tasks))
	{
		print '<tr>';
	 ...
	 print '</table><hr><a href="all_projects_page.php">Back!</a></body></html>';
?>